...
%
%
function [sharedVol, Len1, Len2] = share_boundary_tree (intree1, intree2, options)
...
bound1           = boundary_tree (intree1, '-3d', c1); % Get boundary
bound2           = boundary_tree (intree2, '-3d', c2); % Get boundary
